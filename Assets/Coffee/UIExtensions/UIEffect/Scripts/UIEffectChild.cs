...
namespace Coffee.UIExtensions
{
    ...
    public class UIEffectMaterialResolver : MonoBehaviour, IMaterialModifier, IMeshModifier
    {
        ...
        public Material GetModifiedMaterial(Material baseMaterial)
        {
            ...
            var modifier = transform.parent.GetComponent<BaseMaterialEffect>();
            ...
            {
                modifiedMaterial = MaterialCache.Register(baseMaterial, _effectMaterialHash, modifier.ModifyMaterial);
            }
