...
namespace Coffee.UIEffects
{
    ...
    public class UIEffectProjectSettings : PreloadedProjectSettings<UIEffectProjectSettings>
    {
        ...
        {
            base.OnEnable();
            shaderRegistry.onShaderRequested = ShaderSampleImporter.ImportShaderIfSelected;
            shaderRegistry.ClearCache();
        }

        protected override void OnCreateAsset()
        {
            shaderRegistry.InitializeIfNeeded(this);
            shaderRegistry.RegisterOptionalShaders(this);
        }
